...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2024 at 03:25 AM
...
INSERT INTO `payments` (`id`, `student_id`, `registration_id`, `amount`, `payment_date`, `file`, `description`, `status`) VALUES
(20, 32, 18, 1700000.00, '2024-12-21 01:17:05', '../uploads/payments/struk.jpeg', 'siswa1 bayar', 'completed'),
(22, 34, 20, 1700000.00, '2024-12-21 02:13:24', '../uploads/payments/struk.jpeg', 'siswa2 bayar', 'completed');
...
(17, 32, 1, 1, 'SD', 'Kurikulum 2013', 'Januari', 2025, 3, '1700000', '2024-12-21 08:14:21'),
(18, 32, 1, 7, 'SMP', 'Kurikulum 2013', 'Januari', 2025, 3, '1700000', '2024-12-21 08:17:05'),
(20, 34, 1, 12, 'SMA', 'Kurikulum 2013', 'Januari', 2024, 3, '1700000', '2024-12-21 09:13:24');
...
(32, 'siswa1', 'a102282b5ba22d361d85d002db1bb5f2435d098ba2eff3888cbb2737ee4da1b5', 1, '2024-12-21 08:13:58', 'siswa1@gmail.com', '3424234', '19', '1902', '1902060', 'siswa1', 0),
(34, 'siswa2', '152468b70af86c106c94e5c10c810b4f39295162fe3242cfd1c34778d428228c', 1, '2024-12-21 09:13:05', 'siswa2@gmail.com', '21342443543', '32', '3215', '3215112', 'siswa2 alamat', 0);
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`registration_id`) REFERENCES `registrations` (`registration_id`) ON DELETE CASCADE ON UPDATE CASCADE;
